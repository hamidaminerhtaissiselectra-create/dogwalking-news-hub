  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
      ...
      <div className="grid md:grid-cols-4 gap-4">
        <Card className="shadow-lg bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 border-green-200">
          <CardContent className="pt-6">
            <div className="flex items-center justify-between mb-2">
              <p className="text-sm text-muted-foreground">Net ce mois</p>
              <TrendingUp className="h-5 w-5 text-green-600" />
            </div>
            <p className="text-3xl font-bold text-green-600">{summary.thisMonthNet.toFixed(0)}€</p>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg">
          <CardContent className="pt-6">
            ...
            <p className="text-3xl font-bold text-amber-600">{summary.totalCommission.toFixed(0)}€</p>
                ...
                >
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-right text-sm">
                      ...
                      <p className="text-amber-600">-{invoice.commission.toFixed(2)}€</p>
                    </div>
                    <div className="text-right">
                      <p className="font-bold text-lg text-green-600">+{invoice.netAmount.toFixed(2)}€</p>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
